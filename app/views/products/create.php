...
<body>
    <main class="card">
        ...
        <div class="card-body">
            ...
            <form id="productForm" method="POST" action="<?= site_url('products/store') ?>">
                ...
                <div class="actions">
                    ...
                    <a class="btn cancel" href="<?= site_url('products') ?>">
                        Cancel
                    </a>
                </div>
            </form>
        ...
        document.getElementById('productForm').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    alertBox.innerText = 'Product saved successfully!';
                ...
                alertBox.innerText = 'Failed to save product. Please try again.';
                alertBox.style.display = 'block';
            } finally {
